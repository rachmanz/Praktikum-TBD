...
def create_table():
    conn = sq3.connect("../121450128/sqlite/mahasiswa.sqlite")
    c = conn.cursor()
...
def get_all_mahasiswa():
    conn = sq3.connect("../121450128/sqlite/mahasiswa2.sqlite")
    c = conn.cursor() 
...
# Pembuatan tabel mahasiswa dengan ekstensi .sqlite
create_table() 
...
addmahasiswa(103, "Abdurrahman Al-atsary", "Program Studi Sains Data")
...
update_mahasiswa(103, "Abdurrahman Al-atsary", "Program Studi Arsitektur Lanskap")
